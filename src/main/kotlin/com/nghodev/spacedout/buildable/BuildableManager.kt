...
object BuildableManager {
    ...
    fun register(buildable: Buildable){
        ...
        val recipe: ShapedRecipe = ShapedRecipe(NamespacedKey(Instance.plugin, buildable.codeName),
            ItemStack(buildable.placeItemMaterial).apply { itemMeta = itemMeta.apply { setLocalizedName(buildable.placeItemName)
                displayName(Component.text(buildable.placeItemName).decoration(TextDecoration.ITALIC, false)) } })
